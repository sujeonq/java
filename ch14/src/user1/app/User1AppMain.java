...
public class User1AppMain extends JFrame {
	...
	public User1AppMain() {
		...
		// 컬럼 설정
		String[] columNames = { "아이디", "이름", "휴대폰", "나이" };
		...
		btnInsert.setBounds(89, 156, 97, 23);
		...
		btnList.setBounds(12, 156, 75, 23);
