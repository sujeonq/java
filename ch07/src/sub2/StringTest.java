...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열 비교 --> 무조건 equals !!!
		if (str1 == str2) {
			System.out.println("str1, str2가 주소값이 같다.");
		} else {
			System.out.println("str1, str2가 주소값이 다르다.");
		}

		if (str1.equals(str2)) {
			System.out.println("str1, str2가 문자열이 같다.");
		} else {
			System.out.println("str1, str2가 문자열이 다르다.");
		}
